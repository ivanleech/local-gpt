...
#### Note
It might be challenging to install llama-cpp-python. What worked for me was to install cxx-compiler first so that the c++ compiler uses conda compiler instead of the default. 
```
